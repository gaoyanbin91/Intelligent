package com.gao.intelligent.utils.okhttp;
...
//            LogUtils.e(" EncodeUtil.decrypt", "Model.TokenId==="+accessTokenIdModel.accessTokenId);
            ...
            LogUtils.info(TAG + "==accessTokenId==>" + Global.tokenId);

//            Global.getTokenExpire = currentTime;
         //   Utils.setLocalSave(MyApp.getContext(), "Security", "tokenId", Global.tokenId);
           // Utils.setLocalSave(MyApp.getContext(), "Security", "aesKey", Global.aesKey);
            reAuthorizeCode = "200";
