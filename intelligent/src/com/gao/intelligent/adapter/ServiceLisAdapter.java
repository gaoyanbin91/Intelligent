 ...
 * 描述:
 */
public class ServiceLisAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public ServiceLisAdapter(Context mContext, List<DemandBean.RowsBean> mList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == TYPE_FOOTER) {
            ...
            return new MyViewHolder(LayoutInflater.from(mContext).inflate(R.layout.item_service_lis, parent, false));
        }
    }
