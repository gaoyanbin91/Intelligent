...
public class MyDecoration13_10_13dp extends RecyclerView.ItemDecoration {
...
//    };
    ...
    public MyDecoration13_10_13dp(Context context, int orientation) {
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        if (mOrientation == HORIZONTAL_LIST) {
            ...
            if (0 == pos) {
                ...
                outRect.set(26, 0, mDivider.getIntrinsicWidth(), 0);

            } else if (parent.getAdapter().getItemCount() - 1 == pos) {

                outRect.set(0, 0, 26, 0);
