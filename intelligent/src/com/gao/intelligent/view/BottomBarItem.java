...
public class BottomBarItem extends LinearLayout {
    ...
    private int mTextSize = 12;//文字大小 默认12sp
    private int mTextColorNormal = 0xFF999999;   //描述文本的默认显示颜色
    private int mTextColorSelected = 0xFF46C01B; //描述文本的默认选中颜色
    private int mMarginTop = 0;//文字和图标的距离， 默认为0
    ...
    private int mItemPadding;//BottonBarItem的padding
    ...
    private void init() {
        ...
        mTextView.setTextSize(TypedValue.COMPLEX_UNIT_PX, mTextSize);//设置底部文字大小
