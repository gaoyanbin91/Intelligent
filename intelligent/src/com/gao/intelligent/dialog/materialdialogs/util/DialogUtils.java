...
public class DialogUtils {
    ...
    public static ColorStateList getActionTextColorStateList(Context context, @ColorRes int colorId) {
        ...
        if (value.type >= TypedValue.TYPE_FIRST_COLOR_INT && value.type <= TypedValue.TYPE_LAST_COLOR_INT) {
            ...
            if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.LOLLIPOP_MR1) {
                ...
                return context.getResources().getColorStateList(colorId);//context.getColorStateList(colorId);
            }
        }
    }
    ...
    public static int getColor(Context context, @ColorRes int colorId) {
        if (Build.VERSION.SDK_INT <= Build.VERSION_CODES.LOLLIPOP_MR1) {
            ...
            return context.getResources().getColor(colorId);//context.getColor(colorId);
        }
    }
