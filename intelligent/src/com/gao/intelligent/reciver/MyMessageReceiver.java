...
import com.gao.intelligent.model.NoticeBean;
...
//        MainApplication.setConsoleText("onNotificationReceivedInApp ： " + " : " + title + " : " + summary);
    ...
    public void onMessage(Context context, CPushMessage cPushMessage) {
        ToastUtils.showShort(cPushMessage.getTitle()+ ", content:" + cPushMessage.getContent());
...
//        MainApplication.setConsoleText("onNotificationOpened ： " + " : " + title + " : " + summary + " : " + extraMap);
        NoticeBean noticeBean = JSON.parseObject(extraMap, NoticeBean.class);
        Intent i = new Intent(context , ProblemDetailActivity.class);
        i.addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
        i.putExtra("id", noticeBean.getId());
        i.putExtra("type", "");
...
//        MyApp.setConsoleText("onNotificationClickedWithNoAction ： " + " : " + title + " : " + summary + " : " + extraMap);
    }
}
